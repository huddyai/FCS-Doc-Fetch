...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    // FCS Green #92C973 and a manually created darker hover shade
    primary: "border-transparent text-white bg-fcs-green hover:bg-fcs-green-400 focus:ring-fcs-green-500 shadow-sm",
    secondary: "border-gray-300 text-gray-700 bg-white hover:bg-gray-50 focus:ring-fcs-green-500 shadow-sm",
